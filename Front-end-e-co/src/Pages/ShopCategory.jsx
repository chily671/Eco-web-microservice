...
const ProductListPage = () => {
  ...
  const currentProducts = viewProductIds
    ...
    .filter(
      (product) =>
        product &&
        (product.sex === "Men's watch/Unisex" || product.sex === "Men's watch")
    );
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="relative w-full md:w-96">
            <input
              type="text"
              placeholder="Search products in Men's watch..."
          ...
          <div className="flex gap-4">
            <select
              className="h-fit px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="flex gap-4">
              ...
              <input
                type="number"
                id="min-price"
                className="px-2 py-2 mt-1 mb-[10px] border rounded-lg"
                onChange={(e) =>
